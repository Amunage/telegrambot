...
TELEGRAM_GROUP_IDS=-1001234567890,889998272
TELEGRAM_ADMIN_IDS=123456789
BOT_IDLE_REPLY_PROB=0.05
```
...
문제가 해결되지 않으면 `logs`와 함께 이슈를 등록하거나 PR을 보내 주세요.

---

## 라이선스

프로젝트 내 코드에 별도 라이선스가 명시되어 있지 않으므로, 배포 전 관리자와 상의하거나 필요 시 MIT 등의 라이선스를 추가 설정하세요.
